...
export interface Recipe {
  ...
  mealType: MealType; viral?: boolean; viralNote?: string; platform?: string
}
export interface FoodPreferences {
  proteins: string[]; carbs: string[]; fruits: string[]; vegetables: string[]; dietaryRestrictions: string[]
}
...
export const ACTIVITY_LABELS: Record<ActivityLevel, string> = {
  ...
  moderate: 'Moderately active (3-5 days/week)', active: 'Very active (6-7 days/week)', very_active: 'Extra active (physical job)'
}
